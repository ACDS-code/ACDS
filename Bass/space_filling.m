...
%% output
dlmwrite('space_filling4.txt',mean(error_gamma));
dlmwrite('space_filling4.txt',std(error_gamma),'-append');
dlmwrite('space_filling4.txt',mean(error_l2),'-append');
dlmwrite('space_filling4.txt',std(error_l2),'-append');
dlmwrite('space_filling4.txt',mean(sample),'-append');
dlmwrite('space_filling4.txt',std(sample),'-append');
