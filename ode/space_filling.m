...
%% output
dlmwrite('space_filling2.txt',mean(error_gamma));
dlmwrite('space_filling2.txt',std(error_gamma),'-append');
dlmwrite('space_filling2.txt',mean(error_l2),'-append');
dlmwrite('space_filling2.txt',std(error_l2),'-append');
