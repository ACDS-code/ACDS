...
%% output
dlmwrite('data6.txt',mean(error_gamma));
dlmwrite('data6.txt',std(error_gamma),'-append');
dlmwrite('data6.txt',mean(error_l2),'-append');
dlmwrite('data6.txt',std(error_l2),'-append');
dlmwrite('data6.txt',mean(sample),'-append');
dlmwrite('data6.txt',std(sample),'-append');
